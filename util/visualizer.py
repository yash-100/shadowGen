...
class Visualizer():
    def __init__(self, opt):
        ...
        if self.tf_log:
            ...
            self.writer = tf.compat.v1.summary.FileWriter(str(self.log_dir))
    ...
    def display_current_results(self, visuals, epoch, step):
        ...
        if self.tf_log:  # show images in tensorboard output
            ...
            for label, image_numpy in visuals.items():
                ...
                #scipy.micy.toimage(image_numpy).save(s, format="jpeg")
            ...
            #with self.writer.as_default():
             # self.tf.compat.v1.Summary.Image("summary",summary,step=step)
